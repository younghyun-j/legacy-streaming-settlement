package com.streaming.settlement.scheduler.content;

import com.streaming.settlement.scheduler.content.repository.ContentRepository;
import com.streaming.settlement.scheduler.global.redis.service.ViewCountCacheService;
...
public class ViewCountSyncScheduler {
    ...
    public void syncContentViewCountsToDatabase() {
        String timeWindowKey = viewCountCacheService.getPreviousMinuteViewCountKey();
